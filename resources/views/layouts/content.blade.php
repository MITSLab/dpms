<div class="page-content">
                    ...
                    <div class="card-body mb-0">
                        <div class="row">
                            ...
                            <div class="col-4 align-self-center">
                                <div class="icon-info text-right"><i class="dripicons-cart bg-soft-warning"></i></div>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
                ...
                <div class="card">
                    <div class="card-body mb-0">
                        <div class="row">
                            ...
                            <!--end col-->
                            <div class="col-4 align-self-center">
                                <div class="icon-info text-right"><i class="dripicons-wallet bg-soft-success"></i></div>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
                                    ...
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="text-center">
                                                ...
                                                <div class="icon-info my-3"><i class="dripicons-jewel bg-soft-pink"></i></div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="text-center">
                                                ...
                                                <div class="icon-info my-3"><i class="dripicons-basket bg-soft-info"></i></div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="text-center">
                                                ...
                                                <div class="icon-info my-3"><i class="dripicons-swap bg-soft-primary"></i></div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="text-center">
                                                ...
                                                <div class="icon-info my-3"><i class="dripicons-store bg-soft-warning"></i></div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="text-center">
                                                ...
                                                <div class="icon-info my-3"><i class="dripicons-user-group bg-soft-success"></i></div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mt-2"><img src="{{asset('templates/horizontal/assets')}}/images/flags/us_flag.jpg" alt="" class="mb-2" height="30">
                                    <h5 class="mb-3">Our most customers in America <span class="badge badge-primary">March 2019</span></h5>
                                    <p class="font-13 text-muted mb-0">But who has any right to find fault with a man who chooses to enjoy a pleasure that has no.</p>
                                    <div class="apexchart-wrapper">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        ...
                                        <h3 class="mt-0"><img src="{{asset('templates/horizontal/assets')}}/images/flags/us_flag.jpg" alt="" class="mr-2 thumb-xs rounded-circle">2.8k</h3>
                    ...
                    <div class="card-body new-user order-list">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img class="" src="{{asset('templates/horizontal/assets')}}/images/products/img-1.png" alt="user"></td>
                                        <td>Beg</td>
                                        <td><img src="{{asset('templates/horizontal/assets')}}/images/flags/us_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle"></td>
                                    ...
                                    <!--end tr-->
                                    <tr>
                                        <td><img class="" src="{{asset('templates/horizontal/assets')}}/images/products/img-2.png" alt="user"></td>
                                        <td>Watch</td>
                                        <td><img src="{{asset('templates/horizontal/assets')}}/images/flags/french_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle"></td>
                                    ...
                                    <!--end tr-->
                                    <tr>
                                        <td><img class="" src="{{asset('templates/horizontal/assets')}}/images/products/img-3.png" alt="user"></td>
                                        <td>Headphone</td>
                                        <td><img src="{{asset('templates/horizontal/assets')}}/images/flags/spain_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle"></td>
                                    ...
                                    <!--end tr-->
                                    <tr>
                                        <td><img class="" src="{{asset('templates/horizontal/assets')}}/images/products/img-4.png" alt="user"></td>
                                        <td>Purse</td>
                                        <td><img src="{{asset('templates/horizontal/assets')}}/images/flags/russia_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle"></td>
                                    ...
                                    <!--end tr-->
                                    <tr>
                                        <td><img class="" src="{{asset('templates/horizontal/assets')}}/images/products/img-5.png" alt="user"></td>
                                        <td>Shoe</td>
                                        <td><img src="{{asset('templates/horizontal/assets')}}/images/flags/italy_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle"></td>
                                    ...
                                    <!--end tr-->
                                    <tr>
                                        <td><img class="" src="{{asset('templates/horizontal/assets')}}/images/products/img-6.png" alt="user"></td>
                                        <td>Boll</td>
                                        <td><img src="{{asset('templates/horizontal/assets')}}/images/flags/us_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle"></td>
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body dash-info-carousel">
                        <div id="carousel_best_saler" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="text-center"><img src="{{asset('templates/horizontal/assets')}}/images/users/user-4.jpg" alt="user" class="rounded-circle thumb-xl img-thumbnail mb-1">
                                        <h5>Nancy Flanary</h5>
                                        ...
                                        <div class="mt-2 align-item-center">
                                            <h5 class="font-20 d-inline-block mb-0 mr-3 align-self-center">$34800.00</h5><a class="btn btn-sm btn-primary text-light mb-2"><i class="mdi mdi-email-outline mr-1"></i>Message</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="text-center"><img src="{{asset('templates/horizontal/assets')}}/images/users/user-2.jpg" alt="user" class="rounded-circle thumb-xl img-thumbnail mb-1">
                                        <h5>Donald Gardner</h5>
                                        <p class="font-12 text-muted"><i class="fas fa-globe mr-2"></i>Russia Dealer</p>
                                        <p class="mb-0 text-muted">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin.</p>
                                        <div class="mt-2 align-item-center">
                                            <h5 class="font-20 d-inline-block mb-0 mr-3 align-self-center">$31200.00</h5><a class="btn btn-sm btn-primary text-light mb-2"><i class="mdi mdi-email-outline mr-1"></i>Message</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="text-center"><img src="{{asset('templates/horizontal/assets')}}/images/users/user-1.jpg" alt="user" class="rounded-circle thumb-xl img-thumbnail mb-1">
                                        <h5>Matt Rosales</h5>
                                        <p class="font-12 text-muted"><i class="fas fa-globe mr-2"></i>Spain Dealer</p>
                                        <p class="mb-0 text-muted">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin.</p>
                                        <div class="mt-2 align-item-center">
                                            <h5 class="font-20 d-inline-block mb-0 mr-3 align-self-center">$29200.00</h5><a class="btn btn-sm btn-primary text-light mb-2"><i class="mdi mdi-email-outline mr-1"></i>Message</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body dash-info-carousel">
                        <div id="carousel_review" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="media"><img src="{{asset('templates/horizontal/assets')}}/images/flags/us_flag.jpg" class="mr-2 thumb-xs rounded-circle" alt="...">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="mb-1 text-muted">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised variations of
                                            passages of Lorem Ipsum available.</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="media"><img src="{{asset('templates/horizontal/assets')}}/images/flags/spain_flag.jpg" class="mr-2 thumb-xs rounded-circle" alt="...">
                                        <div class="media-body align-self-center">
                                ...
                                <div class="carousel-item">
                                    <div class="media"><img src="{{asset('templates/horizontal/assets')}}/images/flags/russia_flag.jpg" class="mr-2 thumb-xs rounded-circle" alt="...">
                                        <div class="media-body align-self-center">
    ...
    <!-- container -->
    <footer class="footer text-center text-sm-left">&copy; 2019 Frogetor <span class="text-muted d-none d-sm-inline-block float-right">Crafted with <i class="mdi mdi-heart text-danger"></i> by Mannatthemes</span></footer>
</div>
<!-- end page content -->
