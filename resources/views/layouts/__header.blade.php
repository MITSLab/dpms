        ...
        <div class="sidebar-user media"><img src="{{asset('templates/horizontal/assets')}}/images/users/user-1.jpg" alt="user" class="rounded-circle img-thumbnail mb-1"> <span class="online-icon"><i class="mdi mdi-record text-success"></i></span>
            <div class="media-body">
                ...
                <ul class="list-unstyled list-inline mb-0 mt-2">
                    <li class="list-inline-item"><a href="index.html#" class=""><i class="mdi mdi-account text-light"></i></a></li>
                    <li class="list-inline-item"><a href="index.html#" class=""><i class="mdi mdi-settings text-light"></i></a></li>
                    <li class="list-inline-item"><a href="index.html#" class=""><i class="mdi mdi-power text-danger"></i></a></li>
                </ul>
            </div>
        </div><!-- Page-Title -->
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title mb-2">@yield('header_title')</h4>
                    <div class="">
                        <ol class="breadcrumb">
