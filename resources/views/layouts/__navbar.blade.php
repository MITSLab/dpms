        ...
        <div class="container-fluid">
            <div id="navigation">
                ...
                <ul class="navigation-menu list-unstyled">
                    <li class="has-submenu"><a href="index.html#"><i class="mdi mdi-monitor"></i> Dashboard</a>
                        <ul class="submenu">
                    ...
                    <li class="has-submenu"><a href="index.html#"><i class="mdi mdi-apps"></i>Apps</a>
                        <ul class="submenu">
                            <li><a href="app-chat.html">Chat</a></li>
                            <li><a href="app-calendar.html">Calendar</a></li>
                            <li class="has-submenu"><a href="index.html#">ECommerce</a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu"><a href="index.html#">Email</a>
                                <ul class="submenu">
                    ...
                    <li class="has-submenu"><a href="index.html#"><i class="mdi mdi-buffer"></i>Advanced UI</a>
                        <ul class="submenu">
                    ...
                    <li class="has-submenu"><a href="index.html#"><i class="mdi mdi-cards-playing-outline"></i>UI Elements</a>
                        <ul class="submenu megamenu">
                            ...
                            <li>
                                <ul>
                                    <li>
                                        <p class="font-12 mb-0 py-2 rounded-pill mt-2 badge badge-soft-success">Extra Components</p>
                                    </li>
                    ...
                    <li class="has-submenu"><a href="index.html#"><i class="mdi mdi-arrow-down-drop-circle-outline"></i>More</a>
                        <ul class="submenu">
                            <li class="has-submenu"><a href="index.html#">Icons</a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu"><a href="index.html#">Tables</a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu"><a href="index.html#">Forms</a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu"><a href="index.html#">Maps</a>
                                <ul class="submenu">
                                    <li><a href="maps-google.html">Google Maps</a></li>
                                    <li><a href="maps-vector.html">Vector Maps</a></li>
                                </ul>
                            </li>
                            <li class="has-submenu"><a href="index.html#">Email Templates</a>
                                <ul class="submenu">
                    ...
                    <li class="has-submenu"><a href="index.html#"><i class="mdi mdi-chart-bar"></i>Charts</a>
                        <ul class="submenu">
                    ...
                    <li class="has-submenu"><a href="index.html#"><i class="mdi mdi-book-open-page-variant"></i>Pages</a>
                        <ul class="submenu megamenu">
                            <li>
                                <ul>
