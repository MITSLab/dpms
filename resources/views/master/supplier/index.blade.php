...
@section('header_title')
    <i class="mdi mdi-monitor mr-2"></i>Supplier
@endsection
    ...
    <div class="col-12">
        <x-card>
            <div class="button-items">
                <button onclick="addForm('{{ route('kontak.supplier.store') }}')" type="button" class="btn btn-soft-primary waves-effect waves-light"><i class="fas fa-plus"></i> Baru</button>
            </div>
        </x-card>
    ...
    <script>
        ...
        $(function () {
            table = $('.table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('kontak.supplier.create') }}',
                },
                columns: [
